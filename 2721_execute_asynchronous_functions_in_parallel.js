...
// should be an array of all the resolved values of promises in the same order as they were in the functions. The
// promise should resolve when all the asynchronous functions in the array have completed execution in parallel.
// promise rejects:
...
const promiseAll = function (functions) {
  ...
  return new Promise((resolve, reject) => {
    functions.forEach((promisse, ind) => {
      promisse()
        .then((res) => {
          ans[ind] = res;
          count++;
