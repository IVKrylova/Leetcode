...
// Enhance all functions to have the callPolyfill method. The method accepts an object obj as its first parameter and
...
// }
// Calling this function like tax(10, 0.1) will log "The cost of undefined is 11". This is because the this context was
// not defined.
...
// Explanation: callPolyfill sets the "this" context to {"item": "burger"}. 10 and 1.1 are passed as additional
// arguments.
...
Function.prototype.callPolyfill = function (context, ...args) {
  const fn = this.bind(context, ...args);
  return fn(args);
};
